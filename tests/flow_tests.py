...
class TestFlowLoading(TestCase):
    ...
    def test_topic_uuid(self):
        ...
        site = self.site
        topic = Topic(site, 'Topic:Sh6wgo5tu3qui1w2')
...
class TestFlowFactoryErrors(TestCase):
    ...
    def test_illegal_arguments(self):
        ...
        real_topic = Topic(site, 'Topic:Slbktgav46omarsd')
        fake_topic = Topic(site, 'Topic:Abcdefgh12345678')
        # Topic.from_topiclist_data
        self.assertRaises(TypeError, Topic.from_topiclist_data, site, '', {})
